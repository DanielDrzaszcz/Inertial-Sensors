...
public class MagnetometerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        magnetometerViewModel.getGraphSeriesX().observe(this, new Observer<LineGraphSeries<DataPoint>>() {
        ...
        magnetometerViewModel.getGraphSeriesY().observe(this, new Observer<LineGraphSeries<DataPoint>>() {
        ...
        magnetometerViewModel.getGraphSeriesZ().observe(this, new Observer<LineGraphSeries<DataPoint>>() {
            @Override
            public void onChanged(LineGraphSeries<DataPoint> dataPointLineGraphSeries) {
                graph.addSeries(dataPointLineGraphSeries);
            }
